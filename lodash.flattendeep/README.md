# lodash.flattendeep v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.flattenDeep`](http://lodash.com/docs#flattenDeep) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
