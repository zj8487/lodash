# lodash.mixin v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.mixin`](http://lodash.com/docs#mixin) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
