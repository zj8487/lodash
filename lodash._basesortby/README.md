# lodash._basesortby v3.0.0-pre

The internal [Lo-Dash](http://lodash.com/) function `baseSortBy` as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
