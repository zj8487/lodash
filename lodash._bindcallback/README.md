# lodash._bindcallback v3.0.0-pre

The internal [Lo-Dash](http://lodash.com/) function `bindCallback` as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
