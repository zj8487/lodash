# lodash.max v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.max`](http://lodash.com/docs#max) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
