# lodash.sortbyall v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.sortByAll`](http://lodash.com/docs#sortByAll) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
