# lodash.initial v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.initial`](http://lodash.com/docs#initial) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
