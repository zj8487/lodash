# lodash.reescape v3.0.0-pre

The [Lo-Dash](http://lodash.com/) variable [`_.reEscape`](http://lodash.com/docs#reEscape) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
