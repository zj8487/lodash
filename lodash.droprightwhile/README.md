# lodash.droprightwhile v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.dropRightWhile`](http://lodash.com/docs#dropRightWhile) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
