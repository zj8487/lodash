# lodash._baseuniq v3.0.0-pre

The internal [Lo-Dash](http://lodash.com/) function `baseUniq` as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
