# lodash.clone v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.clone`](http://lodash.com/docs#clone) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
