# lodash.chunk v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.chunk`](http://lodash.com/docs#chunk) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
