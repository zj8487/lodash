# lodash.rest v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.rest`](http://lodash.com/docs#rest) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
