# lodash.partialright v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.partialRight`](http://lodash.com/docs#partialRight) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
