# lodash.reinterpolate v3.0.0-pre

The [Lo-Dash](http://lodash.com/) variable [`_.reInterpolate`](http://lodash.com/docs#reInterpolate) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
