# lodash.reevaluate v3.0.0-pre

The [Lo-Dash](http://lodash.com/) variable [`_.reEvaluate`](http://lodash.com/docs#reEvaluate) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
