# lodash.isequal v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.isEqual`](http://lodash.com/docs#isEqual) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
