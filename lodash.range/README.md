# lodash.range v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.range`](http://lodash.com/docs#range) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
