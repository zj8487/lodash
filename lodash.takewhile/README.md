# lodash.takewhile v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.takeWhile`](http://lodash.com/docs#takeWhile) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
