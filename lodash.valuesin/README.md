# lodash.valuesin v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.valuesIn`](http://lodash.com/docs#valuesIn) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
