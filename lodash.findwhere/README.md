# lodash.findwhere v3.0.0-pre

The [Lo-Dash](http://lodash.com/) function [`_.findWhere`](http://lodash.com/docs#findWhere) as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
